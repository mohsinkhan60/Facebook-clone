...
import { ChevronDown, Clock, Flag, Home, PlayCircle, ShoppingBag, Star, Users, Video } from 'lucide-react'
  ...
  return (
    ...
    <div className="w-[350px] h-screen py-7 px-3 flex flex-col overflow-y-auto scrollbar-hide">
      ...
      <nav className="space-y-1 flex-grow">
        <SidebarItem icon={<Users className="w-7 h-7" />} text="Friends" badge="(136 online)" />
...
const SidebarItem = ({ icon, text, badge }) => {
  return (
    <a href="#" className="flex w-full items-center space-x-4 p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200">
      {icon}
